...
export const TIMER = { title: 'Успейте получить выгодное предложение!',subtitle: '', endtime: `${YEAR}-${MONTH}-${LAST_DAY}T23:59:59+04:00`, btnName: 'GAC на ваших условиях', show: true };
